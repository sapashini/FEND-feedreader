...
19. When completed - all of the tests passed. 

# How  to Run the Project
1. Clone or download the code files to your local machine.
2. Open the project folder and lunch the index.html file in your favorite internet browser.
3. Once the page opens, clicked the 'sandwich menu icon' to toggle off the side bar.
4. Scroll the page to the bottom, a Jasmine test of 7 specs and 0 failures indicates a successful tested project.
